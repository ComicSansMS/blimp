// generated by ../external/sqlpp11/scripts/ddl2cpp -fail-on-parse indexed_locations.ddl indexed_locations blimpdb
#ifndef BLIMPDB_INDEXED_LOCATIONS_H
#define BLIMPDB_INDEXED_LOCATIONS_H
